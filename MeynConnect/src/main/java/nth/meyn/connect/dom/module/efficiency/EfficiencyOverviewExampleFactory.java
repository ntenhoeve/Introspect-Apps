...
public class EfficiencyOverviewExampleFactory {
	...
	public static List<EfficiencyOverview> create() {
		...
		overviews.add(create("Container Departure Line", EfficencyStatus.RunningFullCapacity, 100,100,100,7.9*LINE_SPEED_PER_HOUR-15));
		...
		overviews.add(create("Cut up Line 1", EfficencyStatus.RunningFullCapacity, 100,100,100, 4.5*LINE_SPEED_PER_HOUR));
		overviews.add(create("Cut up Line 2", EfficencyStatus.RunningFullCapacity, 100,100,100, 4.4*LINE_SPEED_PER_HOUR));
		overviews.add(create("Cut up Line 3", EfficencyStatus.RunningFullCapacity, 100,100,100,4.0*LINE_SPEED_PER_HOUR));
		overviews.add(create("Cut up Line 4", EfficencyStatus.RunningFullCapacity, 100,100,100,4.1*LINE_SPEED_PER_HOUR));
