...
public class ComponentCode extends PageColumn  {
	...
	private static final Regex REGEX_PAGE = new Regex().decimal(Repetition.minMax(1, 7));
	private static final Regex REGEX_LETTER = new Regex().letters(Repetition.minMax(1, 1));
	private static final Regex REGEX_COLUMN=new Regex().decimal(Repetition.minMax(1,1));
