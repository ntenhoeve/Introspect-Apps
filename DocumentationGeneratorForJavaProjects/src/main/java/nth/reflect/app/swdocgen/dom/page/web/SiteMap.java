...
public class SiteMap implements WritableFile{
	...
	private final GitHubWebInfo gitHubWebInfo;
	private final File mainPage;

	
	public SiteMap(GitHubWebInfo gitHubWebInfo, File mainPage) {
		this.gitHubWebInfo = gitHubWebInfo;
		this.mainPage = mainPage;
	}

	@Override
	public void write() throws IOException {
		File file = new File(gitHubWebInfo.getGithubWebProjectLocation(),FILE_NAME);
		...
		writer.print("http://");
		writer.print(gitHubWebInfo.getGitHubUserName());
