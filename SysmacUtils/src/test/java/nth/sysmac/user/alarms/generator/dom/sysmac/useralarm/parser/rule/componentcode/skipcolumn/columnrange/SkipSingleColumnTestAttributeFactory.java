...
public class SkipSingleColumnTestAttributeFactory extends RandomExpressionAndNodesFactory {
	...
	public ExpressionAndNodes create(int columnNumber) {
		ExpressionAndNodes expressionAndNodes = TestObjectFactory.tokenNodeUnsignedInteger(columnNumber);
