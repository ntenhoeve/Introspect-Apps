...
/**
*
* <h3>Hidden component code array example</h3>
* Note that you can combine visible, hidden and derived component codes with arrays.
...
* <td align="left" colspan=3 >{30M2} {110K6} belt</td>
* </tr>
* <tr bgcolor="#ffffff">
* <td align="left">Cm</td>
...
* <td align="left">false</td>
* <td align="left">110K6 Plucker belt motor not running</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">110K6 Plucker belt motor not stopped</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">30S3 Plucker belt motor disconnect switch</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">30Q3 Plucker belt motor protection</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">30S4 Plucker belt motor disconnect switch</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">30Q4 Plucker belt motor protection</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">110K8 Plucker belt motor not running</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* <tr bgcolor="#ffffff">
...
* <td align="left">false</td>
* <td align="left">110K8 Plucker belt motor not stopped</td>
* <td align="left">UserFaultLevel5</td>
* <td align="left"></td>
* </tr>
* </table>
...
public class HiddenComponentCodeArrayExampleTest extends ExampleTest {
	...
	private static final int CONTACTOR_COMPONENT_CODE_COLUMN = 6;
	...
	public HiddenComponentCodeArrayExampleTest() {
		setNote("Note that you can combine visible, hidden and derived component codes with arrays.");
		...
		addGivenDataTypeChild(PLUCKER, BELT_VAR, "ARRAY[0..2] OF "+CM + "\\" + MTR_CTRL + "\\" + S_EVENT_DOL,
				"{"+MOTOR_COMPONENT_CODE_PAGE + "M" + MOTOR_COMPONENT_CODE_COLUMN + "} {" +CONTACTOR_COMPONENT_CODE_PAGE + "K" + CONTACTOR_COMPONENT_CODE_COLUMN + "} "+ BELT_MSG);
		...
		for (int index = 0; index < 3; index++) {
			...
			addExpectedUserAlarm(PLUCKER, variableName + "." + PLUCKER + "." + BELT_VAR + "(" + index + ")." + MTR_SW,
					MOTOR_COMPONENT_CODE_PAGE + "S" + (MOTOR_COMPONENT_CODE_COLUMN+index) + " " + PLUCKER + " " + BELT_MSG + " "
			...
			addExpectedUserAlarm(PLUCKER, variableName + "." + PLUCKER + "." + BELT_VAR + "(" + index + ")." + MTR_PROT,
					MOTOR_COMPONENT_CODE_PAGE + "Q" + (MOTOR_COMPONENT_CODE_COLUMN+index) + " " + PLUCKER + " " + BELT_MSG + " "
							+ MOTOR_PROTECTION_WITHOUT_TAG,
					Priority.MEDIUM, ExampleTest.NO_ACKNOWLEDGE, ExampleTest.NO_DETAILS);
			addExpectedUserAlarm(PLUCKER,
					variableName + "." + PLUCKER + "." + BELT_VAR + "(" + index + ")." + NOT_RUNNING,
					CONTACTOR_COMPONENT_CODE_PAGE + "K" + (CONTACTOR_COMPONENT_CODE_COLUMN+index) + " " + PLUCKER + " " + BELT_MSG + " "
							+ MOTOR_NOT_RUNNING_WITHOUT_TAG,
					Priority.MEDIUM, ExampleTest.NO_ACKNOWLEDGE, ExampleTest.NO_DETAILS);
			addExpectedUserAlarm(PLUCKER,
					variableName + "." + PLUCKER + "." + BELT_VAR + "(" + index + ")." + NOT_STOPPED,
					CONTACTOR_COMPONENT_CODE_PAGE + "K" + (CONTACTOR_COMPONENT_CODE_COLUMN+index) + " " + PLUCKER + " " + BELT_MSG + " "
							+ MOTOR_NOT_STOPPED_WITHOUT_TAG,
					Priority.MEDIUM, ExampleTest.NO_ACKNOWLEDGE, ExampleTest.NO_DETAILS);
		}
	}
	...
	public static void main(String[] args) {
		HiddenComponentCodeArrayExampleTest v = new HiddenComponentCodeArrayExampleTest();
		System.out.println(v.toJavaDoc());
	}

	@Test
	void testExample() {
		ExampleTest exampleTest = new HiddenComponentCodeArrayExampleTest();
