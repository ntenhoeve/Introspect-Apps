...
class SkipSingleColumnRuleTest {
	...
	@Test
	void testAppliesTo_givenSkipColumn3_givenComponentCodeWithColumn2_returnFalse() {
		String expression = createSkipSingleColumnAttributeExpression(3);
