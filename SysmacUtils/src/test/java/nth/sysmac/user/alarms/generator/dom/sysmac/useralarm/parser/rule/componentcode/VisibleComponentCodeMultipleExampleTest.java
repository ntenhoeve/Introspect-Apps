...
/**
*
* <h3>Visible component code multiple example</h3>
* Note that visible component codes are no longer displayed when a derived component code is used.
...
public class VisibleComponentCodeMultipleExampleTest extends ExampleTest {
	...
	public VisibleComponentCodeMultipleExampleTest() {
		setNote("Note that visible component codes are no longer displayed when a derived component code is used.");
		...
		addGivenDataTypeChild(MAESTRO, BRUSH_VAR, CM + "\\" + MTR_CTRL + "\\" + S_EVENT_DOL,
				MOTOR_COMPONENT_CODE + " " +MOTOR_DISCONNECT_SWITCH_COMPONENT_CODE + " " + BRUSH_MSG);
	...
	public static void main(String[] args) {
		VisibleComponentCodeMultipleExampleTest v = new VisibleComponentCodeMultipleExampleTest();
		System.out.println(v.toJavaDoc());
	}

	@Test
	void testExample() {
		ExampleTest exampleTest = new VisibleComponentCodeMultipleExampleTest();
