...
/**
 *
 * <h3>Priority rule example</h3> Note: the priority is set with the {prio=.}
 * text
 * <table cellspacing="1" cellpadding="4" bgcolor="#000000">
 * <tr bgcolor="#ffffff">
 * <th colspan=6>Variable: EventGlobal of type: sEvent<br>
 * Data Type's:</th>
 * </tr>
 * <tr bgcolor="#ffffff">
 ...
 * <td align="left">BOOL</td>
 * <td align="left" colspan=3 >{prio=f}Air pressure too low</td>
 * </tr>
 * <tr bgcolor="#ffffff">
 * <td align="left"></td>
 * <td align="left">&nbsp;&nbsp;levelLow</td>
 * <td align="left">BOOL</td>
 * <td align="left" colspan=3 >Level too low{prio=i}</td>
 * </tr>
 * <tr bgcolor="#ffffff">
 ...
 * <td align="left">UserFaultLevel1</td>
 * <td align="left"></td>
 * </tr>
 * <tr bgcolor="#ffffff">
 * <td align="left"></td>
 ...
 * <td align="left">UserInformation</td>
 * <td align="left"></td>
 * </tr>
 * </table>
 *
...
public class PriorityRuleExampleTest extends ExampleTest {
	...
	private static final String PRIO_FATAL = "{prio=f}";
	private static final String PRIO_INFO = "{prio=i}";

	public PriorityRuleExampleTest() {
		setNote("Note: the priority is set with the  {prio=.} text");
		...
		addExpectedUserAlarm(ExampleTest.NO_NAMESPACE, variableName + "." + AIR_PRESSURE_LOW_VAR, AIR_PRESSURE_LOW_MSG,
				Priority.FATAL, ExampleTest.NO_ACKNOWLEDGE, ExampleTest.NO_DETAILS);
		addExpectedUserAlarm(ExampleTest.NO_NAMESPACE, variableName + "." + LEVEL_LOW_VAR, LEVEL_LOW_MSG, Priority.INFO,
